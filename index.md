...
An energy function is used to determine the importance of each pixel in the image. In my implementations, I defined the energy function has the sum of the vertical and horizontal gradients across all 3 channels of the image. E(i,j) = E\_r(i,j) + E\_g(i,j) + E\_b(i,j), where E\_r(i,j) is the sum of the horizontal and vertical gradients in the image's red channel. E\_r(i,j) = 0.5 * (abs(I(i, j-1) - I(i, j+1)) + abs(I(i+1, j) - I(i-1, j))).
